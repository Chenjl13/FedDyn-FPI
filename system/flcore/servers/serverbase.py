    ...
    def save_results(self):
        ...
        if (len(self.rs_test_acc)):
            ...
            with h5py.File(file_path, 'w') as hf:
                ...
                hf.attrs['rho'] = getattr(self.args, 'rho', '')
                hf.attrs['seed'] = getattr(self.args, 'seed', '')
                hf.attrs['global_rounds'] = self.global_rounds
                hf.attrs['local_epochs'] = self.local_epochs
                hf.attrs['batch_size'] = self.batch_size
                hf.attrs['local_learning_rate'] = self.learning_rate
                hf.attrs['feddyn_alpha'] = getattr(self.args, 'alpha', '')
